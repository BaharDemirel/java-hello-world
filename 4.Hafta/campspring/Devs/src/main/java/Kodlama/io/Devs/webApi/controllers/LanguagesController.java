...
public class LanguagesController {
	...
	public LanguagesController() {
		InMemoryProgrammingLanguageRepository LanguageRepo = new InMemoryProgrammingLanguageRepository();
		try {
			LanguageRepo.add(new ProgrammingLanguage(1, "C#"));
			LanguageRepo.add(new ProgrammingLanguage(2, "Java"));
			LanguageRepo.add(new ProgrammingLanguage(3, "Pyton"));
		}catch(Exception e) {
			
		}
		
		this.languageManager = new ProgrammingLanguageManager(LanguageRepo);
	}
